...
public class Third1Activity extends AppCompatActivity {
    ...
    private void OnProceedToTwoWheeler() {
        ...
        Intent intent = new Intent(getApplicationContext(), TwoWheelerNearByZoneActivity.class);
    ...
    private void OnProceedToFourWheeler() {
        ...
        Intent intent = new Intent(getApplicationContext(), FourWheelerNearByZoneActivity.class);
        startActivity(intent);
    } //else {
    // Toast.makeText(getApplicationContext(), "Please select something", Toast.LENGTH_SHORT).show();
    //}
